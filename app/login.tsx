...
export default function LoginScreen() {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            if (!accessToken) {
                Alert.alert(t.APP_NAME, 'Login succeeded but no token returned.');
                return;
            }
            ...
            >
                ...
                >
                    ...
                    <View style={[styles.headerActions, { paddingTop: insets.top + (Platform.OS === 'android' ? 10 : 0) }]}>
                        ...
                        >
                            <Text style={[styles.langText, { color: isDark ? '#FFF' : primaryColor }]}>
                    ...
                    <View style={[styles.bgDecorCircle2, { backgroundColor: isDark ? '#1A3320' : '#E8F5E9' }]} />
                    ...
                    <View style={styles.content}>
                        <Animated.View entering={FadeInDown.delay(200).duration(1000)} style={styles.logoContainer}>
                            ...
                            <Text style={[styles.subtitle, { color: labelColor }]}>
                                {language === 'English' ? 'Sign in to manage your veggie shop' : 'உங்கள் காய்கறி கடையை நிர்வகிக்க உள்நுழையவும்'}
                            </Text>
                        </Animated.View>
                        ...
                        <Animated.View entering={FadeInUp.delay(400).duration(800)} style={styles.formContainer}>
                            ...
                            <View style={[styles.card, { backgroundColor: isDark ? '#1E1E1E' : '#FFF', shadowColor: isDark ? '#000' : '#CCC' }]}>
                                {/* Username */}
                                <View style={styles.inputWrapper}>
                                    <Text style={[styles.label, { color: labelColor }]}>{t.USERNAME}</Text>
                                    <View style={[inputContainerStyle, { backgroundColor: isDark ? '#2C2C2C' : '#F9FAFB' }]}>
                            ...
                            <View style={styles.signupLinkContainer}>
                                ...
                                <TouchableOpacity onPress={() => router.push('/signup')}>
                                    <Text style={[styles.signupLinkText, { color: primaryColor }]}>Sign Up</Text>
                                </TouchableOpacity>
                            </View>
