...
export default function ShopScreen() {
          ...
          styles.card,
          {
            ...
            borderColor: isSelected
              ...
              : isDark
                ? "#333"
                : "transparent",
            borderWidth: isSelected ? scale(1.5) : 0,
          },
        ]}
  ...
  return (
    ...
    >
      ...
      >
        <View>
          <Text style={[styles.shopTitle, { color: primaryColor }]}>
          ...
          >
            <View style={styles.cartInfo}>
              <View style={styles.basketIconBox}>
                <View
                  style={[styles.cartIconBg, { backgroundColor: accentColor }]}
                >
      ...
      >
        ...
        >
          <View style={styles.invoiceHeader}>
            ...
            <Text style={[styles.invoiceTitle, { color: textColor }]}>
              Invoice Preview
            </Text>
            <TouchableOpacity
              onPress={finalizeBill}
              style={[styles.printBtn, { backgroundColor: primaryColor }]}
            >
          ...
          >
            ...
            <View style={[styles.shopHeader, { backgroundColor: cardBg }]}>
              ...
              <View style={styles.shopInfo}>
                <Text style={[styles.shopNameText, { color: textColor }]}>
                  {user?.shopName || "Vegetable Shop"}
                </Text>
                <Text style={[styles.shopDetails, { color: labelColor }]}>
                  Southern Market, Tamil Nadu
                </Text>
                <Text style={[styles.shopDetails, { color: labelColor }]}>
                  PH: {user?.username}
                </Text>
            ...
            <View style={[styles.tableContainer, { backgroundColor: cardBg }]}>
              ...
              >
                ...
                <Text
                  style={[styles.headLabel, { flex: 1.5, textAlign: "center" }]}
                >
                  QTY/KG
                </Text>
                <Text
                  style={[styles.headLabel, { flex: 1.5, textAlign: "right" }]}
                >
                  PRICE
                </Text>
                <Text
                  style={[styles.headLabel, { flex: 2, textAlign: "right" }]}
                >
                  TOTAL
                </Text>
              </View>
              ...
              {cart.map((item) => (
                ...
                >
                  <View style={{ flex: 3 }}>
                    <Text style={[styles.itemTamil, { color: textColor }]}>
                      {item.tamilName}
                    </Text>
                    <Text style={[styles.itemEng, { color: labelColor }]}>
                      {item.name}
                    </Text>
                  </View>
                  ...
                  <View style={{ flex: 2, alignItems: "flex-end" }}>
                    <Text style={[styles.rowTotal, { color: primaryColor }]}>
              ...
              <View style={styles.invoiceSummary}>
                <View style={styles.summaryItem}>
                  ...
                  <Text style={[styles.summaryVal, { color: textColor }]}>
                    {cart.length}
                  </Text>
                </View>
