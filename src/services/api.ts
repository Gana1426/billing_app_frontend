...
export const API_BASE_URL = "http://192.168.1.156:8000/api/v1"; // Use 10.0.2.2 for Android Emulator, or your LAN IP for physical device
...
export const inventoryApi = {
  ...
  update: (vegId: string, data: any) => api.put(`/inventory/${vegId}`, data),
  dailyPricing: (data: any) => api.post("/inventory/daily-pricing", data),
};
...
export const billApi = {
  ...
  getPdf: (billId: string) =>
    api.get(`/billing/${billId}/pdf`, { responseType: "blob" }),
};
