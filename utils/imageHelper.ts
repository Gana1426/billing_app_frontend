...
export const getVegetableImage = (image: string, name?: string): ImageSourcePropType => {
    if (!image) {
    ...
    if (image.startsWith('local://')) {
        ...
        return imageMap[imageName] || { uri: 'https://cdn-icons-png.flaticon.com/512/135/135687.png' };
    }
