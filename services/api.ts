...
export const API_BASE_URL = "http://localhost:5000/api/v1"; // Use 10.0.2.2 for Android Emulator, or your LAN IP for physical device
...
export const inventoryApi = {
  ...
  update: (vegId: string, data: any) =>
    api.put(`/inventory/${vegId}`, data),
